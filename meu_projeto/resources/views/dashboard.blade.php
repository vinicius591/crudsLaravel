    ...
    <aside class="w-64 bg-white border-r border-slate-200 min-h-screen flex-shrink-0 flex flex-col justify-between hidden md:flex shadow-sm">
        <div>
            ...
            <nav class="p-4 space-y-1.5">
                ...
                <a href="{{ route('cardapios.index') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-xl transition duration-200 {{ request()->is('cardapios*') ? 'bg-orange-50 text-orange-700 font-semibold' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-950' }}">
