        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-gray-200 pb-5 mb-8">
                ...
                <div class="mt-4 sm:mt-0">
                    <a href="{{ route('mesas.create') }}" class="inline-flex items-center justify-center px-4 py-2.5 border border-transparent rounded-lg text-sm font-medium text-gray-500 bg-blue-600 hover:bg-blue-700 shadow-sm transition duration-150 ease-in-out">
